		...
		try {
			writeFileSync(
				...
				[
					...
					'import type { AbstractLemma, ApiResult, Descriptor, DumlingBase64Url, EntityForKind, EntityValue, IdDecodeError, IdDecodeSuccess, LanguageApi, Lemma, ParseError, Selection, SelectionOptionsFor, SupportedLanguage, Surface } from "dumling/types";',
					"",
