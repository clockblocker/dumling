	...
	it("accepts core inflectional schemas across the richer POS classes", () => {
		expect(
			GermanAdjectiveSchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "ADJ", "klein"),
		...
		expect(
			GermanAdpositionSchemas.InflectionSelectionSchema.safeParse({
				...
				spelledSelection: "zu",
				surface: {
					...makeLexemeSurfaceReference("German", "ADP", "zu"),
					inflectionalFeatures: {},
					language: "German",
		...
		expect(
			GermanAuxiliarySchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "AUX", "sein"),
					inflectionalFeatures: {
						mood: "Ind",
						number: "Sing",
						person: "3",
		...
		expect(
			GermanDeterminerSchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "DET", "dies"),
					inflectionalFeatures: {
						case: "Nom",
						gender: "Masc",
						number: "Sing",
		...
		expect(
			GermanPronounSchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "PRON", "sich"),
					inflectionalFeatures: {
						case: "Dat",
						number: "Sing",
						reflex: "Yes",
		...
		expect(
			GermanProperNounSchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "PROPN", "Angela"),
					inflectionalFeatures: {
						case: "Gen",
						number: "Sing",
					},
	...
	it("accepts restored UD German feature families and multi-valued feature bags", () => {
		expect(
			GermanAuxiliarySchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "AUX", "werden"),
					inflectionalFeatures: {
						aspect: "Perf",
						verbForm: "Part",
						voice: "Pass",
		...
		expect(
			GermanDeterminerSchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "DET", "dessen"),
					inflectionalFeatures: {
						gender: ["Masc", "Neut"],
	...
	it("keeps the non-inflecting classes strict", () => {
		...
		expect(
			GermanInterjectionSchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "INTJ", "ach"),
					inflectionalFeatures: {},
					language: "German",
		...
		expect(
			GermanPunctuationSchemas.InflectionSelectionSchema.safeParse({
				...
				spelledSelection: ",",
				surface: {
					...makeLexemeSurfaceReference("German", "PUNCT", ","),
					inflectionalFeatures: {},
					language: "German",
	...
	it("rejects unsupported feature values where subsets matter", () => {
		...
		expect(
			GermanOtherSchemas.InflectionSelectionSchema.safeParse({
				...
				surface: {
					...makeLexemeSurfaceReference("German", "X", "foobar"),
					inflectionalFeatures: {
						tense: "Past",
					},
					language: "German",
