...
export type UniversalFeatures = {
	...
	extPos?: ExtPos;
	foreign?: Foreign;
	gender?: FeatureValueSet<Gender>;
	"gender[psor]"?: FeatureValueSet<Gender>;
	...
	nounClass?: NounClass;
	numForm?: NumForm;
	number?: FeatureValueSet<GrammaticalNumber>;
	"number[psor]"?: GrammaticalNumber;
	numType?: NumType;
	partType?: PartType;
	person?: FeatureValueSet<Person>;
	phrasal?: Phrasal;
	polarity?: Polarity;
	polite?: Polite;
	poss?: Poss;
	prefix?: Prefix;
	pronType?: FeatureValueSet<PronType>;
	punctType?: PunctType;
	reflex?: Reflex;
	style?: Style;
	tense?: Tense;
...
export type UniversalFeatureBag = UniversalFeatures;
export type UniversalFeatureName = keyof UniversalFeatures;
