...
export function buildDePhrasemeSchemaBundle<
	TLemma extends Lemma<"de", "Phraseme", PhrasemeSubKind>,
>(options: {
	...
	}) as unknown as z.ZodType<Surface<"de", "Lemma", "Phraseme", TLemmaSubKind>>;
	const standardLemmaSelectionSchema = buildSelectionSchema({
		languageSchema: options.languageSchema,
		orthographicStatus: "Standard",
		surfaceSchema: lemmaSurfaceSchema,
	}) as unknown as z.ZodType<
		Selection<"de", "Standard", "Lemma", "Phraseme", TLemmaSubKind>
	>;
	const typoLemmaSelectionSchema = buildSelectionSchema({
		...
		Selection<"de", "Typo", "Lemma", "Phraseme", TLemmaSubKind>
	>;
