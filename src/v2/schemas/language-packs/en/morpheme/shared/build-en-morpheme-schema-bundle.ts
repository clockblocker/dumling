...
export function buildEnMorphemeSchemaBundle<
	TLemma extends Lemma<"en", "Morpheme", MorphemeSubKind>,
>(options: {
	...
	}) as unknown as z.ZodType<Surface<"en", "Lemma", "Morpheme", TLemmaSubKind>>;
	const standardLemmaSelectionSchema = buildSelectionSchema({
		languageSchema: options.languageSchema,
		orthographicStatus: "Standard",
		surfaceSchema: lemmaSurfaceSchema,
	}) as unknown as z.ZodType<
		Selection<"en", "Standard", "Lemma", "Morpheme", TLemmaSubKind>
	>;
	const typoLemmaSelectionSchema = buildSelectionSchema({
		...
		Selection<"en", "Typo", "Lemma", "Morpheme", TLemmaSubKind>
	>;
