...
export function buildHeMorphemeSchemaBundle<
	TLemma extends Lemma<"he", "Morpheme", MorphemeSubKind>,
>(options: {
	...
	}) as unknown as z.ZodType<Surface<"he", "Lemma", "Morpheme", TLemmaSubKind>>;
	const standardLemmaSelectionSchema = buildSelectionSchema({
		languageSchema: options.languageSchema,
		orthographicStatus: "Standard",
		surfaceSchema: lemmaSurfaceSchema,
	}) as unknown as z.ZodType<
		Selection<"he", "Standard", "Lemma", "Morpheme", TLemmaSubKind>
	>;
	const typoLemmaSelectionSchema = buildSelectionSchema({
		...
		Selection<"he", "Typo", "Lemma", "Morpheme", TLemmaSubKind>
	>;
